  ...
  const features = [
    {
      ...
      description: "Perform computations directly on encrypted votes without decryption, ensuring complete privacy and security throughout the entire voting process. Perfect for maintaining vote secrecy while allowing transparent tallying.",
    ...
    },
    {
      ...
      description: "Dynamic encryption keys that change over time, making it virtually impossible for attackers to compromise votes. Perfect for ensuring that votes remain sealed until the designated counting time.",
    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="fixed top-0 left-0 right-0 bg-white/80 backdrop-blur-sm z-50 px-8 py-4 flex justify-between items-center border-b">
        ...
        <nav className="hidden md:flex items-center gap-8">
          ...
          <a href="#" className="text-gray-700 hover:text-indigo-600">Security</a>
          <button className="bg-indigo-600 text-white px-6 py-2 rounded-full flex items-center gap-2 hover:bg-indigo-700">
            Start Voting <ChevronRight size={16} />
          </button>
        </nav>
        <button className="md:hidden text-gray-700"><Menu size={24} /></button>
      </header>
      ...
      <section className="relative min-h-screen flex items-center">
        {carouselItems.map((item, index) => (
          <div
            key={index}
            className={`absolute inset-0 transition-opacity duration-500 ${item.bgColor} ${
          ...
          >
            ...
            <div className="relative h-full flex items-center px-8 md:px-16 lg:px-24">
              <div className="max-w-4xl text-white">
                ...
                <button className="bg-white text-indigo-600 px-8 py-3 rounded-full flex items-center gap-2 hover:bg-gray-100 w-fit">
      ...
      <section className="py-24 px-8 md:px-16 lg:px-24 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold mb-16 text-center">Advanced Security Features</h2>
      ...
      <section className="py-24 px-8 md:px-16 lg:px-24">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl font-bold mb-16 text-center">Why Choose TruVote?</h2>
          <div className="grid md:grid-cols-3 gap-8">
            {benefits.map((benefit, index) => (
              <div key={index} className="text-center p-6 rounded-xl hover:bg-gray-50">
